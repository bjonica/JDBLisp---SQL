...
public class SymbolTable {
    ...
    protected Map<Symbol, VariableEntry> getMap()
    {
    	return variables;
    }
    ...
    public Symbol bind(Symbol s, FormEntry f) {
        ...
        functions.put(s, f);
        //System.out.println("BINDING 1" + s);
        return s;
    }
    ...
    public Symbol bind(Symbol s, VariableEntry v) {
        if (variables.get(s) != null) {
          System.out.println("Rebinding variable " + s );
          try{
          rebind(s, v);
          }
          catch(Exception e)
        ...
        System.out.println("BINDING " + s + " " + v.value);
        variables.put(s, v);
        return s;
    }


		public Symbol unbind(Symbol s) {
        if (variables.get(s) != null) {
            // TODO: warning: variable redefinition
            // Also, check access permissions
        }
        System.out.println("UNBINDING  " + s);
        variables.remove(s);
        return s;
    }
    /**
    ...
    public Symbol rebind(Symbol s, VariableEntry v) throws LispException {
        ...
        // it is present
         ...
         System.out.println("REBINDING " + s);
        return s;
    }
