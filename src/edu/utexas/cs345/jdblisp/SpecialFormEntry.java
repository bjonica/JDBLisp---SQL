 ...
 * Enhanced by Carine Iskander (carine_iskander@mail.utexas.edu) & Pia Chakrabarti (piachakra@mail.utexas.edu)
 */
public abstract class SpecialFormEntry extends FormEntry {
	
	 boolean inletd = false;
    ...
    static final Symbol QUESTION            = new Symbol("NULL?");
    static final Symbol ISSYMBOL            = new Symbol("SYMBOL?");
    static final Symbol ISATOM          	  = new Symbol("ATOM?");
    static final Symbol ISNUM            	  = new Symbol("NUM?");
    static final Symbol ISLIST              = new Symbol("LIST?");
    static final Symbol CAR                 = new Symbol("CAR");
    static final Symbol CADR                = new Symbol("CADR");
    static final Symbol LAST                = new Symbol("LAST");
    static final Symbol CDR                 = new Symbol("CDR");  
    static final Symbol EQUALS              = new Symbol("EQUALS");  
    ...
    static final Symbol LETD                = new Symbol("LETD");
    ...
    public static void defineSpecialForms(LISPRuntime environment) {
        ...
        // ---
        // DIV
		// fixed by Pia Chakrabarti & Carine Iskander
        // ---
           ...
           //     System.out.println("7");
             ...
             //   System.out.println("symbol table" + symbolTable.toString());
                if (arguments == null)
					...
					ArrayList<Num> argarray = new ArrayList<Num>();
					do{
					    argarray.add(TypeUtil.attemptCast(Num.class,
                    arguments.car.eval(symbolTable)));
					    arguments = arguments.cdr;
                ...
                if(argarray.size() == 1)
                	 answer = dividend.divideBy(argarray.get(0));
                	 
                	//  System.out.println("answer when dividing by 1" + answer);
                	 
              if(argarray.size() == 2){
                	 
                	 dividend = argarray.get(0);
                 answer = dividend.divideBy(argarray.get(1));}
            ...
            throws LispException {
             ...
             //   System.out.println(symbolTable.toString());
                ...
                difference = difference.subtract(TypeUtil.attemptCast(
                    Num.class,
                    arguments.car.eval(symbolTable)));
					// System.out.println("outside " + arguments.car.eval(symbolTable));  
                arguments = arguments.cdr;
                ...
                while (arguments != null)  {
                    difference = difference.subtract(TypeUtil.attemptCast(Num.class,arguments.car.eval(symbolTable)));
			//	   System.out.println("in while " + arguments.car.eval(symbolTable));                    
                    arguments = arguments.cdr;
                    ...
                    + "evaluates to a number."))
        {
            ...
            //   System.out.println(  symbolTable.toString());
                ...
                // variable number of arguments [0..inf)
                while (arguments != null) {
           //     System.out.println("arguments in sum " + arguments.car.eval(symbolTable));
                    sum = sum.add(TypeUtil.attemptCast(
                        Num.class,arguments.car.eval(symbolTable)));
               //     System.out.println("in sum while " + arguments.car.eval(symbolTable));  
                    arguments = arguments.cdr;
                }
        ...
        // NULList
        // ---
	 	 final SpecialFormEntry  QUESTION  = new SpecialFormEntry(
            SpecialFormEntry.QUESTION , environment,
            new FormHelpTopic("null?", "checks if list is null",
                "(car <List>) => <SExp>",
	    ...
	    list = arguments.car.eval(symbolTable);
            if(list.toString().equals("NIL"))
		return SExp.T;
            else
		return SExp.NIL;
       }
	 		...
	 		// ---
        // ISSymbol
		// added by Pia Chakrabarti and Carine Iskander
        // ---
	 	 final SpecialFormEntry  ISSYMBOL  = new SpecialFormEntry(
            SpecialFormEntry.ISSYMBOL , environment,
            new FormHelpTopic("symbol?", "checks if is symbol",
               "(<symbol>*) => result",
                "Is true if symbol, else nil",
                "symbol", "a symbol",
                "result", "a boolean"))
        {
            public SExp call(SymbolTable symbolTable, Seq arguments)
            ...
            SExp symbol;
	   		...
	   		symbol = arguments.car.eval(symbolTable);
		...
		// added by Pia Chakrabarti and Carine Iskander
        // ---
	 	 final SpecialFormEntry  ISNUM  = new SpecialFormEntry(
            SpecialFormEntry.ISNUM , environment,
     
            new FormHelpTopic("num?", "checks if num",
               "(<num>*) => result",
                "Is true if num, else nil",
                "num", "a num",
                "result", "a boolean"))
        {
            public SExp call(SymbolTable symbolTable, Seq arguments)
		...
		// added by Pia Chakrabarti and Carine Iskander
        // ---
	 	 final SpecialFormEntry  ISATOM  = new SpecialFormEntry(
            SpecialFormEntry.ISATOM , environment,
        
            new FormHelpTopic("atom?", "checks if atomic",
               "(<atom>*) => result",
                "Is true if atom, else nil",
                "atom", "an atom",
                "result", "a boolean"))
        {
            public SExp call(SymbolTable symbolTable, Seq arguments)
            ...
            SExp atom;
	   		...
	   		atom = arguments.car.eval(symbolTable);
	   		
            if(atom instanceof Num || atom instanceof Symbol)
					return SExp.T;
            else
					return SExp.NIL;
       }
	        ...
	        // ISList
			//added by Pia Chakrabarti & Carine Iskander
        // ---
	 	 final SpecialFormEntry  ISLIST  = new SpecialFormEntry(
            SpecialFormEntry.ISLIST , environment,
             new FormHelpTopic("list?", "checks if list",
               "(<list>*) => result",
                "Is true if list, else nil",
                "list", "a list",
                "result", "a boolean"))
        {
            public SExp call(SymbolTable symbolTable, Seq arguments)
		...
		// added by Pia Chakrabarti & Carine Iskander
        // ---
        final SpecialFormEntry LAST = new SpecialFormEntry(
            SpecialFormEntry.LAST, environment,
            new FormHelpTopic("LAST", "gets last element of a list",
                "(last <List>) => <SExp>",
                "Creates a new Sexp whose value is the same as the last element of <List> ",
                "List", "a list",
                "last", "an sexp"))
        {
            public SExp call(SymbolTable symbolTable, Seq arguments)
            throws LispException {
               ...
               if(object instanceof List) 
               {
				   	...
				   	cdr = new Cdr(list.seq.cdr);
				  		while(list != null)
				  		{
				 			if(list.seq.cdr == null)
				   			break;
				   		list = new List(list.seq.cdr);
				   		car = new Car(list.seq.car);
				   	}
				   //return list.seq.car;
				   	return car.sexp;
		...
		// added by Pia Chakrabarti & Carine Iskander
        // ---
        final SpecialFormEntry EQUALS = new SpecialFormEntry(
            SpecialFormEntry.EQUALS, environment,
            new FormHelpTopic("EQUALS", "checks to see if Sexp are equal",
                "(<Sexp>) => <result>",
                "Returns T if equal, else returns nil",
                "Sexp", "an sexp",
                "result", "a boolean"))
        {
            public SExp call(SymbolTable symbolTable, Seq arguments)
            throws LispException {
             ...
             //                  System.out.println("17");
               ...
               {
				  		list1 = (List)object1;
				   	objectsub1 = list1.seq.car;
				   	list1 = new List(list1.seq.cdr);
				   	objectsub2 = list1.seq.car;
				   	
				   	if(objectsub1 instanceof List && objectsub2 instanceof List)
				   	{
				   		listsub1 = (List) objectsub1;
				   		listsub2 = (List) objectsub2;
				   			//check for same length
							do
							{
					 				car1 = new Car(listsub1.seq.car);
				   				car2 = new Car(listsub2.seq.car);
				   								   				
				   				if(!car1.toString().equals(car2.toString()))
				   				{
				   						return SExp.NIL; //for now?
				   				}
				   				if(listsub1.seq.cdr != null && listsub2.seq.cdr != null)
									{
										listsub1 = new List(listsub1.seq.cdr);
										listsub2 = new List(listsub2.seq.cdr);
									}
									else if(listsub1.seq.cdr == null && listsub2.seq.cdr != null)
									{
										return SExp.NIL;
									}
									else if(listsub1.seq.cdr != null && listsub2.seq.cdr == null)
				  		 ...
				  		 if(objectsub1 instanceof Num && objectsub2 instanceof Num)
               	{
               		
               		Num num1 = (Num)objectsub1;
               		Num num2 = (Num)objectsub2;
            	    ...
            	    if(objectsub1 instanceof Symbol && objectsub2 instanceof Symbol)
               	{
               		Symbol s1 = (Symbol)objectsub1;
		...
		// added by Pia Chakrabarti & Carine Iskander
        // ---
        final SpecialFormEntry CADR = new SpecialFormEntry(
            SpecialFormEntry.CADR, environment,
            new FormHelpTopic("CADR", "get second element of list",
                "(list <List>) => <SExp>",
                "Creates a new Sexp whose value is the same as the second element of <List> ",
                "List", "a list",
                "SExp", "an sexp"))
        {
            public SExp call(SymbolTable symbolTable, Seq arguments)
	   ...
	   final SpecialFormEntry CDR = new SpecialFormEntry(
            ...
            new FormHelpTopic("CDR", "get first element of a list",
                "(cdr <List>) => <SExp>",
                "Creates a new Sexp whose value is the same as the first element of <List> ",
                "List", "a list",
                "cdr", "an sexp"))
...
//System.out.println("27");
        ...
        //        System.out.println("func in  FUNCALL " + func);
                FormEntry fe = null;
                arguments = arguments.cdr;
         //       System.out.println("arguments in FUNCALL " + arguments);

					//System.out.println("in funcall " + arguments.toString());
                // cast if already a form entry
                if (func instanceof FormEntry)
                { fe = (FormEntry) func;
          //      	System.out.println("FUNCALL fun is formentry");
                }

                // lookup the function if it is a symbol
                if (func instanceof Symbol) {
            //    System.out.println("FUNCALL fun is a symbol");
                    fe = environment.globalSymbolTable
                        .lookupFunction((Symbol) func);
                    if (fe == null)
               //     System.out.println("FUNCALL fe is null2");
                        throw new UndefinedFunctionException((Symbol) func);
                }

                if (fe == null)
                {
                //	System.out.println("FUNCALL fe is null");
                    throw new TypeException(func, FormEntry.class);
                    }
                if(fe instanceof Lambda)
                {
               // 	System.out.println("FE IS AN INSTANCE OF LAMBDA");

               // 	System.out.println("funcall letd " + super.getLetD());
                	fe.setLetD(super.getLetD());
...
//System.out.println("32");
	...
	//			 System.out.println("IM IN LAMBDA");
		//		System.out.println(symbolTable.toString());
                ...
                body = arguments.car;
           //     System.out.println("getLetD in lambda " + super.getLetD());
			//    System.out.println("new setLetD in lambda: " + super.setLetD(super.getLetD()));
			    
                return new Lambda(parameters.toArray(new Symbol[]{}),
                    body, symbolTable, super.getLetD());
            }
        };
                ...
                "result", "the value returned by the last form"))
        {
            ...
            throws LispException {
             ...
             //   System.out.println(symbolTable.toString());
               ...
               // 	System.out.println("taking " + symbols.get(i) + " " + values.get(i) +  " in");
                    newScope.bind(symbols.get(i),
					  ...
					  {
					   if (i > 1)
					  		newScope.unbind(symbols.get(i -1));
					  		          		
					  }*/
                // evaluate all forms with the new scope
               // System.out.println("new scope in let " + newScope.toString());
                symbolTable = newScope;
                arguments = arguments.cdr;
        ...
        final SpecialFormEntry LETD = new SpecialFormEntry(
            SpecialFormEntry.LETD, environment,
            new FormHelpTopic("LETD", "create new lexical variable bindings dynamically",
                "(letd (([<var> <init-form>])*) <form>*) => <result>",
                "letd creates new variable bindings and executes a series of "
                    + "forms that use these bindings. let performs the "
                    + "bindings in parallel (as opposed to let* which does "
                    + "them sequentially). The form (let ((var1 init-form-1) "
                    + "(var2 init-form-2) ...  (varm init-form-m)) form1 form2 "
                ...
                "result", "the value returned by the last form"))
        {
            ...
            throws LispException {
            	...
            	super.setLetD(true);
           // 	System.out.println("I'm in letd 8-) and letd is " + super.getLetD());
           ...
           //     System.out.println(symbolTable.toString());
             ...
             //   System.out.println("before we leave letd " + super.getLetD());
                return retVal;
            }
        };
...
//System.out.println("35");
                ...
                while (letBinding != null) {
                    ...
                    if (binding == null) initvalue = SExp.NIL;
							...
							//System.out.println("Binding in let* " + var + " to " + initvalue);
...
//System.out.println("41");
        ...
        environment.globalSymbolTable.bind(QUESTION.symbol, QUESTION);
        environment.globalSymbolTable.bind(ISSYMBOL.symbol, ISSYMBOL);
		  environment.globalSymbolTable.bind(ISNUM.symbol, ISNUM);
		  environment.globalSymbolTable.bind(ISATOM.symbol, ISATOM);
		  environment.globalSymbolTable.bind(ISLIST.symbol, ISLIST);
	     environment.globalSymbolTable.bind(CAR.symbol, CAR);
	 	  environment.globalSymbolTable.bind(CDR.symbol, CDR);
	 	  environment.globalSymbolTable.bind(EQUALS.symbol, EQUALS);
		  environment.globalSymbolTable.bind(CADR.symbol, CADR);
        ...
        environment.globalSymbolTable.bind(LETD.symbol, LETD);
        ...
        environment.globalSymbolTable.bind(LAST.symbol, LAST);
