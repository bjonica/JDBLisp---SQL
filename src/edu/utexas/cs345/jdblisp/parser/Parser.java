  ...
  Token t; List colList;
    ...
    case DATABASE:
      ...
      t = jj_consume_token(STRG);
                              {if (true) return SQLQuery("CREATE DATABASE " + new Str(t.image));}
      break;
    default:
      jj_la1[2] = jj_gen;
      if (jj_2_3(3)) {
        ...
        t = jj_consume_token(STRG);
                                        {if (true) return SQLQuery("CREATE TABLE " + new Str(t.image));}
      } else if (jj_2_4(3)) {
        jj_consume_token(TABLE);
        t = jj_consume_token(STRG);
        colList = list();
                                                         {if (true) return SQLQuery("CREATE TABLE " + new Str(t.image) + listToSQL(colList));}
      } else {
        jj_consume_token(-1);
        throw new ParseException();
      }
 ...
 */
  ...
  static private boolean jj_3_4() {
    ...
    if (jj_scan_token(STRG)) return true;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0xfe,0xfe,0x200000,0x1f00,0x1fd000,0xa01fdffe,0xa0000000,0xa01fdffe,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x0,0x0,0x0,0x77,0x0,0x77,0x44,};
   }
